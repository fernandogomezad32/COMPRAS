...
export function CustomerManagement() {
  ...
  const loadUserRole = async () => {
    try {
      ...
      console.log('🔍 [CustomerManagement] User role loaded:', role);
      setUserRole(role);
    } catch (error) {
      console.error('Error loading user role:', error);
      console.log('🚨 [CustomerManagement] Defaulting to employee role due to error');
  ...
  // Para empleados, mostrar vista de solo lectura
  if (userRole === 'employee') {
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Consulta información de clientes registrados</p>
          </div>
